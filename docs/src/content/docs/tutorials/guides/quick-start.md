...
<iframe src="/chronos-vector/plots/quickstart_velocity.html" width="100%" height="450" style="border:none; border-radius:8px; margin:1rem 0;"></iframe>
...
<iframe src="/chronos-vector/plots/quickstart_hurst.html" width="100%" height="450" style="border:none; border-radius:8px; margin:1rem 0;"></iframe>
...
<iframe src="/chronos-vector/plots/quickstart_changepoints.html" width="100%" height="450" style="border:none; border-radius:8px; margin:1rem 0;"></iframe>
...
<iframe src="/chronos-vector/plots/quickstart_regions.html" width="100%" height="400" style="border:none; border-radius:8px; margin:1rem 0;"></iframe>

## Trajectory Visualization

Three synthetic entities show distinct behaviors in embedding space:

<iframe src="/chronos-vector/plots/quickstart_trajectories.html" width="100%" height="400" style="border:none; border-radius:8px; margin:1rem 0;"></iframe>
