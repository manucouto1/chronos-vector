...
|-------|-------|--------|--------|
| 1 | Feature flags & dependencies (`tch 0.17`) | Low | Proposed |
| 2 | Configuration (`model_path` in TOML) | Low | Proposed |
| 3 | TorchScript loader + inference (`torch_ode.rs`) | Medium | Proposed |
| 4 | Query engine integration (fallback to linear) | Medium | Proposed |
| 5 | Python training script (PyTorch + torchdiffeq) | Low | Proposed |
| 6 | Rust training API (tch-rs) | Medium | Proposed |
| 7 | Python bindings update (PyO3) | Low | Proposed |
