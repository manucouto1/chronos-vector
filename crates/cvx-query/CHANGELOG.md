...
## [0.1.1](https://github.com/manucouto1/chronos-vector/compare/cvx-query-v0.1.0...cvx-query-v0.1.1) - 2026-03-20
...
- Initial release with query engine with 15 temporal query types
